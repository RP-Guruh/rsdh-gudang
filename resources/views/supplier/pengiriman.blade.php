    ...
    <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
        ...
        <div class="flex flex-wrap">
            <div class="container mx-auto lg:px-4 px-2 -mt-6 lg:mt-0">
                <div class="py-8">
                    <div>
                        <h2 class="text-2xl font-semibold leading-tight">Data Pengiriman</h2>
                    </div>
                ...
                <div class="inline-flex -mt-8  xs:mt-0">
                    <a href="{{ route('supplier/tambah/pengiriman') }}"
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div class="flex item-center justify-center">
                                                <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                    <a
                                                        href="{{ url('supplier/detail/penawaran/' . $data->kode_pengiriman) }}">
                                                ...
                                                <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                    <a
                                                        href="{{ url('supplier/hapus/penawaran/' . $data->kode_pengiriman) }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
